...
if(isset($_GET["id"])) {
    $sql  = "UPDATE payment_type  SET is_delete = '0' ";
    $sql .= " WHERE id = '".$_GET["id"]."'";
	echo "<font color='blue'>นำกลับเข้าไปสู่หมวดเสร็จสิ้น</font><br/><br/>";  
...
$db_conn->close();
echo "<meta http-equiv='Refresh' content='1;url=f_spay_deletetype.php'>\n";
