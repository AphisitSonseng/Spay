...
if(isset($_GET["id"])) {
    $sql  = "UPDATE payment  SET is_delete = '0' ";
    $sql .= " WHERE id = '".$_GET["id"]."'";
	echo "<font color='blue'>นำกลับเข้าไปสู่รายการเสร็จสิ้น</font><br/><br/>";  
...
$db_conn->close();
echo "<meta http-equiv='Refresh' content='1;url=f_spay_deletelist.php'>\n";
?>